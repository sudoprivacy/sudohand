...
use praxis_browser::flow::{self, run_graph, StepTask};
use praxis_browser::registry::Registry;
use praxis_browser::workflow::{Runner, Step};
use praxis_browser::Error as BrowserError;
use praxis_core::Error;
...
async fn soft_failures_fail_the_step_and_goto_recovers() {
    ...
    // The browser error type maps onto praxis categories.
